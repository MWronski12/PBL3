...
class RFDevice:
    ...
    def __init__(self, gpio,
        ...
        self._rx_change_count = 0 # Number of edges detected
    ...
    def _rx_waveform(self, pnum, change_count, timestamp):
        ...
        if self._rx_change_count > 6 and code != 0:
            ...
            self.rx_bitlength = int(change_count / 2) # Every bit representation consists a rising and and a falling edge
